...
class GaitCommand(CommandTerm):
    ...
    def _update_command(self):
        ...
        standing_env_ids = self._env.command_manager._terms["base_velocity"].is_standing_env.nonzero(as_tuple=False).flatten()
        self.gait_command[standing_env_ids, 0] = 0.01  # Set frequency to 0 for standing envs
        self.gait_command[standing_env_ids, 1] = 0.01  # Set phase offset to 0 for standing envs
        self.gait_command[standing_env_ids, 2] = 0.99  # Set contact duration to 0.5 for standing envs
        self.gait_command[standing_env_ids, 3] = 0.0  # Set swing height to 0.1 for standing envs
