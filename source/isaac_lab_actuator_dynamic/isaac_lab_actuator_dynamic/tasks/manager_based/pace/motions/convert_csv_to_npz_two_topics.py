...
Examples:
  ...
  python source/isaac_lab_actuator_dynamic/isaac_lab_actuator_dynamic/tasks/direct/actuator_dynamic/motions/convert_csv_to_npz_two_topics.py \
      --csv source/isaac_lab_actuator_dynamic/isaac_lab_actuator_dynamic/tasks/direct/actuator_dynamic/motions/recorded_left_leg.csv \
      --t0 43 --t1 50 \
      --out motions/recorded_left_leg_data_1.npz --resample-to-fps --fps 500 --plot
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--cmd-topic", type=str, default="/joint_cmds", help="Command topic name (label)")
