...
class GaitCommand(CommandTerm):
    ...
    def _update_command(self):
        ...
        self.gait_command[standing_env_ids, 0] = 0.0  # Set frequency to 0 for standing envs
        self.gait_command[standing_env_ids, 1] = 0.0  # Set phase offset to 0 for standing envs
        self.gait_command[standing_env_ids, 2] = 1.0  # Set contact duration to 1.0 for standing envs
        self.gait_command[standing_env_ids, 3] = 0.0  # Set swing height to 0.0 for standing envs
