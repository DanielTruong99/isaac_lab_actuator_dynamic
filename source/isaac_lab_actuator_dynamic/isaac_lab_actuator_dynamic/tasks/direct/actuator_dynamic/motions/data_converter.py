...
motion_file = "source/isaac_lab_actuator_dynamic/isaac_lab_actuator_dynamic/tasks/direct/actuator_dynamic/motions/recorded_motor_data.csv"
...
L_hip2_joint_position_command_index = motion_data["topic"] == "/filtered_joint_cmd.position[1]"
...
time_stamp_range =[1748497633.81, 1748497643.83]
data_dict = {
    "fps": np.array(200),
