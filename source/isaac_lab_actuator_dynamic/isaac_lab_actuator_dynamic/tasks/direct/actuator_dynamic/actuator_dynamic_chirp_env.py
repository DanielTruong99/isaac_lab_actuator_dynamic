...
class ActuatorDynamicChirpEnv(DirectRLEnv):
    ...
    def _post_physics_steps(self):
        ...
        self.recorded_joint_pos, self.recorded_joint_vels, self.recorded_joint_pos_cmds, self.recorded_joint_efforts = self._motion_loader.sample(self._motion_ids, motion_times=times)
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        times = self.episode_length_buf * self._motion_loader.dt[self._motion_ids]
        _, _, self.joint_pos_cmds, self.dof_efforts = self._motion_loader.sample(self._motion_ids, times)
